class DashboardController < ApplicationController
  ...
  def index
    ...
    @current_month_payments = current_user.payments.where(payment_date: @current_month_start..Date.today).sum(:amount)
    @beginning_balance_total = @accounts.sum(:beginning_balance)
